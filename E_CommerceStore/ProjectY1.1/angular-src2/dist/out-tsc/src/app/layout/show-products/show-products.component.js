...
var ShowProductsComponent = (function () {
    function ShowProductsComponent(route, productService) {
        this.route = route;
    ...
    ShowProductsComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            _this.searchWord = params['searchWord'];
            //console.log(this.searchWord);
            _this.productService.getProductsByKeyWord(_this.searchWord).subscribe(function (data) {
                if (data.success) {
...
exports.ShowProductsComponent = ShowProductsComponent;
