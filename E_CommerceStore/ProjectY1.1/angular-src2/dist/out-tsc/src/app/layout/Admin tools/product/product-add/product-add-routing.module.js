...
var routes = [
    { path: '', component: product_add_component_1.ProductAddComponent }
];
var ProductAddRoutingModule = (function () {
    function ProductAddRoutingModule() {
    }
    return ProductAddRoutingModule;
}());
ProductAddRoutingModule = __decorate([
    core_1.NgModule({
        imports: [router_1.RouterModule.forChild(routes)],
        exports: [router_1.RouterModule]
    })
], ProductAddRoutingModule);
exports.ProductAddRoutingModule = ProductAddRoutingModule;
